...
/** 注册一个 Channel 实现 */
export declare function registerChannel(descriptor: ChannelDescriptor): void;
/** 根据类型获取 Channel 描述符 */
export declare function getChannelDescriptor(type: string): ChannelDescriptor | undefined;
/** 获取所有已注册的 Channel 列表（按注册顺序） */
export declare function getAllChannelDescriptors(): ChannelDescriptor[];
